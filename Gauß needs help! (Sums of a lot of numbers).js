...
to keep the bored and unruly young schoolboy Karl Friedrich Gauss busy for a good long time, while he teaching arithmetic to his mates,
...
function f(n){
  var count = 0;
  if (n < 1 || n !== Math.floor(n) || typeof n !== "number") {
    return false;
  }
  else {
    while (n > 0) {
